...
const DetailPage = () => {
    const { singleEvent, isLoading, errorCatchSingleEvent } = useDetailEvents();
    ...
    if (isLoading) {
        ...
        return (
            <>
                    ...
                    <div className="w-full min-h-screen md:max-h-screen">
                        ...
                        <div className="md:max-h-screen md:flex md:flex-wrap">
                            ...
                            <div className="p-4 mb-10 pb-10 flex flex-wrap justify-center w-full md:pb-0 md:mb-0">
                                <h2 className="font-bold w-full text-center pb-2 md:text-2xl text-white">
                                    Scegli un orario per prenotare:
                                </h2>
                ...
                {errorCatchSingleEvent === true && (
                    <div className="w-full flex justify-center items-center  min-h-screen md:max-h-screen">
                        <p className="pr-3 text-white">Dati non disponibilie....</p>
                        <Link to={"/home"}>
                            <button className="bg-white px-3 py-2 rounded-xl font-bold">Torna alla home</button>
                        </Link>
                    </div>
                )}
            </>
